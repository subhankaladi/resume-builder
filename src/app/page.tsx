            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              ...
              >
                ...
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Build a stunning resume with our interactive builder. Choose from professional templates, 
                  customize your content, and download your perfect resume for free.
                </p>
...
const features = [
  ...
  },
  {
    ...
    description: 'Customize every aspect of your resume with our intuitive interface.',
    icon: ({ className }: { className?: string }) => (
      <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    name: 'Free Forever',
    description: 'Create and download unlimited resumes without any cost.',
    icon: ({ className }: { className?: string }) => (
      <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
